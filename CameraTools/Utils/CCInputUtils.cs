...
namespace CameraTools.Utils
{
	public class CCInputUtils
	{
		...
		/// <summary>
		/// Check for keypress and validity of the key.
		/// </summary>
		/// <param name="key">The hotkey</param>
		/// <returns>True if the hotkey is bound and pressed, false otherwise.</returns>
		public static bool GetKeyPress(string key) => !string.IsNullOrEmpty(key) && Input.GetKeyDown(key);
	}
}
